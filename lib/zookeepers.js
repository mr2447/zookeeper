...
function filterByQuery(query, zookeepers) {
    ...
    if (query.age) {
        filteredResults = filteredResults.filter(
            //Since out form data will be coming in as strings, and out JSON is storing age as a number, we must convert the query string to a number to perform a comparision:
